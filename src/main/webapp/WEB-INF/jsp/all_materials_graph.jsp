...
<script type="text/javascript">
    $.ajax({
        "url": "/MaterialReception/material/all_materials_json_graph",
        "type": "GET",
        "datatype": "json"
    }).done(
            function (data1) {
...
<script type="text/javascript">
    $.ajax({
        "url": "/MaterialReception/supplier/all_suppliers_json_graph",
        "type": "GET",
        "datatype": "json"
    }).done(
            function (data1) {
